 ...
 * 
 * @author UCSD MOOC development team and Lucas S
 *
 */
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 List<Integer> distanceOut = new ArrayList<Integer>();
		 List<Integer> getOut = this.getNeighbors(v);
		 	for(int q : getOut) {
		 		List<Integer> temp = this.getNeighbors(q);
		 		distanceOut.addAll(temp);
